Removent `0.1.1` is the first stable release, using native RVP protocol v1.
...
```sh
curl -fsSL https://raw.githubusercontent.com/backrunner/removent/v0.1.1/scripts/install_relay.sh | sh
```
